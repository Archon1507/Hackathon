...
<div class="col-sm-6" style="border-right: 1px solid grey">
    ...
    <div class="col-sm-9">
      <input type="user_id" class="form-control" id="name" placeholder="Enter your name" name="name">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="user_id" class="form-control" id="roll_no" placeholder="Enter your roll no." name="rnumber">
    </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="user_id" class="form-control" id="user_name" placeholder="Enter your user name" name="uname">
    </div>
    </div>
...
<form action="upto.php" method="post">
...
<div class="form-group">
    ...
    <div class="col-sm-10"> 
      <input type="text" class="form-control" id="pwd" placeholder="Enter name" name="tname">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="user_id" placeholder="Enter user id" name="tuname">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10"> 
      <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="tpword" required>
    </div>
  </div>
